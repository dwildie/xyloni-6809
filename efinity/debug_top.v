...
module edb_top (
    ...
    input  la0_e,
    input  la0_RESET,
    input  [15:0] la0_M6809_ADDR,
    input  [7:0] la0_M6809_DATA_IN,
    input  [7:0] la0_M6809_DATA_OUT,
    input  la0_USB_SELECT,
    input  la0_RAM_SELECT,
    input  la0_ROM_SELECT,
    input  la0_M6809_RW
);
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h6c8315a8f9654202900af7de147df662 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
        ...
        .probe1                 ( la0_e ),
        .probe2                 ( la0_RESET ),
        .probe3                 ( la0_M6809_ADDR ),
        .probe4                 ( la0_M6809_DATA_IN ),
        .probe5                 ( la0_M6809_DATA_OUT ),
        .probe6                 ( la0_USB_SELECT ),
        .probe7                 ( la0_RAM_SELECT ),
        .probe8                 ( la0_ROM_SELECT ),
        .probe9                 ( la0_M6809_RW )
    );
